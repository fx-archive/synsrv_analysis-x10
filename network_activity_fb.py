...
def network_activity_figure(bpath, nsp):
    ...
    raster_plot(axs['1,1'], bpath, nsp, tmin=0*second, tmax=nsp['T1'])
    raster_plot(axs['1,2'], bpath, nsp, tmin=nsp['T1']+nsp['T2'],
    ...
    directory = "figures/fb/network_activity"
