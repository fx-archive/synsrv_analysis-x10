...
def synw_log_figure(bpath, nsp):
    ...
    synapse_weights_log(axs['1,1'], bpath, nsp, tstep=0, bins=50,
                        cutoff=10.**(-15))
    synapse_weights_log(axs['2,1'], bpath, nsp, tstep=3, bins=50,
                        cutoff=10.**(-15))
    synapse_weights_log(axs['3,1'], bpath, nsp, tstep=6, bins=50,
                        cutoff=10.**(-15))
    synapse_weights_log(axs['4,1'], bpath, nsp, tstep=10, bins=50,
                        cutoff=10.**(-15))
    synapse_weights_log(axs['5,1'], bpath, nsp, tstep=15, bins=50,
                        cutoff=10.**(-15))
    synapse_weights_log(axs['6,1'], bpath, nsp, tstep=19, bins=50,
                        cutoff=10.**(-15))
    
    synapse_weights_log(axs['1,2'], bpath, nsp, tstep=0, bins=50,
                        cutoff=0.0001)
    synapse_weights_log(axs['2,2'], bpath, nsp, tstep=3, bins=50,
                        cutoff=0.0001)
    synapse_weights_log(axs['3,2'], bpath, nsp, tstep=6, bins=50,
                        cutoff=0.0001)
    synapse_weights_log(axs['4,2'], bpath, nsp, tstep=10, bins=50,
                        cutoff=0.0001)
    synapse_weights_log(axs['5,2'], bpath, nsp, tstep=15, bins=50,
                        cutoff=0.0001)
    synapse_weights_log(axs['6,2'], bpath, nsp, tstep=19, bins=50,
                        cutoff=0.0001)

    synapse_weights_log(axs['1,3'], bpath, nsp, tstep=0, bins=50,
                        cutoff=0.001)
    synapse_weights_log(axs['2,3'], bpath, nsp, tstep=3, bins=50,
                        cutoff=0.001)
    synapse_weights_log(axs['3,3'], bpath, nsp, tstep=6, bins=50,
                        cutoff=0.001)
    synapse_weights_log(axs['4,3'], bpath, nsp, tstep=10, bins=50,
                        cutoff=0.001)
    synapse_weights_log(axs['5,3'], bpath, nsp, tstep=15, bins=50,
                        cutoff=0.001)
    synapse_weights_log(axs['6,3'], bpath, nsp, tstep=19, bins=50,
                        cutoff=0.001)
